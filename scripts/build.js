...
function findWorkspaceRoot(startDir) {
  ...
  throw new Error(
    "Could not find workspace root (no pnpm-workspace.yaml or package.json workspaces)",
  );
}
...
function getDeploymentDomain() {
  ...
  console.warn(
    "No EXPO_PUBLIC_DOMAIN or DEPLOYMENT_DOMAIN; using localhost for static build URLs.",
  );
  return "localhost";
}
...
function getExpoPublicReplId() {
  return process.env.EXPO_PUBLIC_REPL_ID ?? undefined;
}
